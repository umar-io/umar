...
const Hero = () => {
    return (
        <section className="w-full px-6 lg:py-8 md:py-[0] lg:px-[50px] flex justify-between items-center gap-8 space-default">
            <article className="lg:w-1/2 xl:w-1/2 md:w-full flex w-full flex-col lg:items-start items-center justify-center h-[400px] gap-4">
            ...
            <aside className="w-1/2 p-8 h-[400px] hidden lg:flex justify-center rounded-lg">
